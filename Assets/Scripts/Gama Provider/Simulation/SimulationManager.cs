...
public class SimulationManager : MonoBehaviour
{
    ...
    void OnEnable() {
        ...
        ConnectionManager.Instance.OnConnectionStateChange += HandleConnectionStateChange;
    }
    ...
    private async void HandleServerMessageReceived(string firstKey, string content) {
        ...
        switch (firstKey) {
            ...
            default:
                Debug.LogError("GameManager: Received unknown message from middleware : " + firstKey);
                break;
        }
